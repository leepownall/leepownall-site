...
class FetchBodyBatteryJob implements ShouldQueue
{
    use Dispatchable;
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $stepsUrl = "https://connect.garmin.com/modern/body-battery/{$today}";
            ...
            $evaluation = $page->evaluate('
                (function() {
                    const elements = document.querySelectorAll("div[class*=\'BodyBatteryGauge_mostRecentValue__\']");
